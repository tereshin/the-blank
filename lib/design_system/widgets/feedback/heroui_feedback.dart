...
///
/// The track is a light gray ring; the indicator is a gradient arc that
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, _) => CustomPaint(
          painter: _SpinnerPainter(
            ...
            trackColor: const Color(0xFFE1E1E2),
...
class _SpinnerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Spinner arc (270° sweep, rotates)
    final sweepAngle = 1.5 * math.pi; // 270°
