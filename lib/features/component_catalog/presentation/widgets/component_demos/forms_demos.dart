...
const String _kInputAffixGlobeIcon = HeroUiIconManifest.globe;
const String _kInputAffixCopyIcon = HeroUiIconManifest.copyLine;
const String _kInputAffixHandsetIcon = HeroUiIconManifest.phoneLine;
const String _kInputAffixEnvelopeIcon = HeroUiIconManifest.envelope;
const String _kInputAffixEyeSlashIcon = HeroUiIconManifest.eyeCloseLine;
const String _kIconLock = HeroUiIconManifest.lock;
const String _kIconKey = HeroUiIconManifest.key1Line;
