...
List<Widget> _buttonIconVariants() => [
  HeroUiButton(
    ...
    onPressed: () {},
    variant: HeroUiButtonVariant.primary,
    leading: const _ButtonGroupIcon(HeroUiIconManifest.globeRegular),
  ),
  HeroUiButton(
    label: 'Add member',
    onPressed: () {},
    variant: HeroUiButtonVariant.secondary,
    leading: const _ButtonGroupIcon(HeroUiIconManifest.plusRegular),
  ),
  HeroUiButton(
    label: 'Delete',
    onPressed: () {},
    variant: HeroUiButtonVariant.danger,
    leading: const _ButtonGroupIcon(HeroUiIconManifest.trashBinRegular),
  ),
  HeroUiButton(
    label: 'Email',
    onPressed: () {},
    variant: HeroUiButtonVariant.tertiary,
    leading: const _ButtonGroupIcon(HeroUiIconManifest.envelopeRegular),
  ),
  HeroUiButton(
    label: 'Follow',
    onPressed: () {},
    variant: HeroUiButtonVariant.outline,
    leading: const _ButtonGroupIcon(HeroUiIconManifest.personPlusRegular),
  ),
  HeroUiButton(
    label: 'Go back',
    onPressed: () {},
    variant: HeroUiButtonVariant.ghost,
    leading: const _ButtonGroupIcon(HeroUiIconManifest.arrowLeftRegular),
  ),
  HeroUiButton(
    label: 'Cancel',
    onPressed: () {},
